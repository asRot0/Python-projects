...
class ImageViewer:
    def __init__(self, root):
        ...
        self.image_info_label = Label(self.root, text="info", bg='#CFCFCF', padx=5, pady=5)
        ...
        self.edit_frame.grid(row=0, column=1, rowspan=1, sticky='nsew')
        ...
        self.save_image_button = Button(self.edit_frame, text="Save Image", bg='#BDBFBF',
                                        state="disabled")
    ...
    def update_image_info(self, file_path):
        ...
        image_tk = self.images[self.image_index][1]
